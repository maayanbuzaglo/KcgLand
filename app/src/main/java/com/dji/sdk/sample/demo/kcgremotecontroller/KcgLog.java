...
public class KcgLog {
    ...
    private String header="TimeMS,date,time,Lat,Lon,Alt,HeadDirection,VelocityX,VelocityY,VelocityZ,yaw,pitch,roll,UsAlt,GimbalPitch," +
                "batRemainingTime,batCharge,Real/kalman,MarkerX,MarkerY,MarkerZ,PitchOutput,RollOutput,ErrorX,ErrorY,P,I,D,MaxI,AutonomousMode";
    ...
    public void appendLog(Map<String,Double> droneTelemetry,Map<String,Double> controlStatus){
        ...
        try {
            ...
            sb.append(format(controlStatus.get("MarkerZ")) + ",");
            ...
            sb.append(format(controlStatus.get("P")) + ",");
            sb.append(format(controlStatus.get("I")) + ",");
            sb.append(format(controlStatus.get("D")) + ",");
